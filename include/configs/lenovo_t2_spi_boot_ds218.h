...
#ifndef __CONFIG_RTK_LENOVO_T2_SPI_BOOT_DS218_H
#define __CONFIG_RTK_LENOVO_T2_SPI_BOOT_DS218_H
...
#define CONFIG_PORT1_POWER_PIN			116
#define SSCEN 0
...
#define CONFIG_BOARD_LENOVO_T2
#undef CONFIG_SYS_PROMPT
#define CONFIG_SYS_PROMPT        		"Lenovo_T2> "

/* FAN */
#define CONFIG_FAN_ENABLE_GPIO_NUM   122
/* PWM command interface */
#define CONFIG_CMD_RTKPWM
/* PWM hardware driver */
#define CONFIG_RTD129X_PWM
#define FAN_PWM_PORT_NUM 1
...
#define CONFIG_SYNO_HDD_PARAMS   "syno_hdd_detect=119,120 HddHotplug=2"
...
#define CONFIG_SYNO_USB_PARAMS  "syno_castrated_xhc=xhci-hcd.5.auto@1 syno_usb_vbus_gpio=102@xhci-hcd.2.auto@0,132@xhci-hcd.5.auto@0,133@xhci-hcd.8.auto@0"

#define CONFIG_AW2015

#include <configs/rtd129x_ds218_parameter.h>

#endif /*__CONFIG_RTK_LENOVO_T2_SPI_BOOT_DS218_H */